"""Websocket server for communication with Airtable module."""
...
from ayon_airtable.backend.rest_api import AirtableModuleRestAPI
...
class WebServer:
    ...
    def start(self) -> None:
        """Starts WebServer."""
        rest_api = AirtableModuleRestAPI(self.app.router)
        rest_api.register()
...
class WebServerThread(threading.Thread):
    ...
    def _run_webserver_loop(self) -> None:
        ...
        os.environ["AIRTABLE_WEBSERVER_URL"] = webserver_url
